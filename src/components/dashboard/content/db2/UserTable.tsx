          ...
          <table className="min-w-full text-sm text-left">
            <thead className="bg-violet-50 dark:bg-violet-900/40 border-b-2 border-dashed border-violet-300 dark:border-violet-700">
              <tr>
                ...
                <th className="px-4 py-2 font-bold text-fuchsia-700 dark:text-fuchsia-300">Username</th>
                ...
                <th className="px-4 py-2 font-bold text-violet-700 dark:text-violet-300">Is Staff</th>
                <th className="px-4 py-2 font-bold text-violet-700 dark:text-violet-300">Active</th>
            ...
            <tbody>
              {filteredData.map((user: any, index: number) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 font-mono">{user.date_joined}</td>
                </tr>
              ))}
            </tbody>
          </table>
